...
class Codevog_Navigation_Block_Navigation extends Mage_Catalog_Block_Navigation
{
        ...
        $isOutermost = false, $outermostItemClass = '', $childrenWrapClass = '', $noEventAttributes = false)
    {
	    ...
	    if ( $level == 0 ) {
		    ...
		    if ( empty($description) || !Mage::getStoreConfig('templatesettings/templatesettings_navigation/show_description') ) {
			    $columns = 4;
		    } else {
			    $columns = 2;
		    }
	    ...
	    if ( !empty($description) && !empty($htmlChildren) && Mage::getStoreConfig('templatesettings/templatesettings_navigation/show_description') ) {
            $htmlChildren .= '<li class="menu-category-description clearfix">'.$description;
		    if ( Mage::getStoreConfig('templatesettings/templatesettings_navigation/show_learn_more') ) {
