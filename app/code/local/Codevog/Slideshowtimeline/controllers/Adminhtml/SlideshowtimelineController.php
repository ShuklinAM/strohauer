...
class Codevog_Slideshowtimeline_Adminhtml_SlideshowtimelineController extends Mage_Adminhtml_Controller_Action
{

	protected function _initAction() {
		$this->loadLayout()
			->_setActiveMenu('codevog/slideshowtimeline/items')
		...
		if ($data = $this->getRequest()->getPost()) {
			...
			if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != null) {
				try {	
					...
					$path = Mage::getBaseDir('media') . DS.'codevog/slideshowtimeline'.DS ;
		        ...
		        $data['image'] = 'codevog/slideshowtimeline/'.$_FILES['image']['name'];
			}
