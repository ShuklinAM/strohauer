...
class Codevog_Templatesettings_Block_Adminhtml_System_Config_Form_Field_Slider extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
    ...
    protected function _optionToHtml($element, $option, $selected)
    {
	    ...
	    $html .= '<img src="'.Mage::getDesign()->getSkinUrl('images/codevog/template/slider_'.$option['value'].'.jpg').'" alt="" /><br/>';
